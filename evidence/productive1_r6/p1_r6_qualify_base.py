# R6 provenance: byte-copy of evidence/productive1_r5/p1_r5_qualify_base.py
# (qualification-r5-execution-pr @ ef906d8 - the copy that survived the full
# live R5 qualification run). All paths/states are overridden by
# p1_r6_qualify.py; the trial loop, prep, freeze/release, and E==F==R==H
# logic are unchanged and battle-tested across the R3/R4/R5 runs.
# R5 provenance: byte-copy of evidence/productive1_r4/p1_r4_qualify_base.py
# (qualification-r4-execution-pr @ 410cac1). All paths/states are overridden
# by p1_r5_qualify.py; this base is the battle-tested R3/R4 trial loop.
